	...
	switch(randomVar) {
		...
		case RIGHT:
		    if(room->r_right != nullptr) {
				...
				room->r_right = new Room(this, sala, type, room, nullptr,
                        nullptr, nullptr, stage_id);
			...
			case TOP:
		        if(room->r_top != nullptr) {
				    CreateRoom(room->r_top, id, x, y-1, qnt, stage_id);
                        ...
                        (room->room_type() != "Cela" ||
						(room->room_type() == "Cela" && room->r_bottom))) {
                    if(type == "Cela") {
                    	type += 'V';
                	}
				    room->r_top = new Room(this, sala, type, nullptr, nullptr,
                            nullptr, room, stage_id);
			...
			case BOTTOM:
		    	if(room->r_bottom != nullptr) {
				    ...
				    room->r_bottom = new Room(this, sala, type, nullptr,
                            room, nullptr, nullptr, stage_id);
...
void Map::GenerateMap(int quantidade_salas, int stage_id) {
	...
	Room *room = new Room(this, "sala 0", "None", nullptr, nullptr,
                          nullptr, nullptr, stage_id);
